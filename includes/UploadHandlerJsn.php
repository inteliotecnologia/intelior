...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            'script_url' => $this->get_full_url().'/form.php?uploadArquivos',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/uploads/anexos_temp/',
            'upload_url' => $this->get_full_url().'/uploads/anexos_temp/',
            'user_dirs' => true,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            'accept_file_types' => '/\.(gif|jpe?g|png|bmp|doc|docx|xls|xlsx|ppt|pptx|pages|numbers|pdf|rtf|dwg|zip|rar|txt)$/i',
            //'/.+$/i',
    ...
    protected function get_upload_path($file_name = null, $version = null) {
        ...
        //$file_name= retira_acentos($file_name);
        if (empty($version)) {
            $version_path = '';
        } else {
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            logs($_SESSION[id_acesso], $_SESSION[id_usuario], $_SESSION[perfil], 1, $id_emissao, 'memorandos', 'Carrega arquivos', 'Tipo: '. $type .' | Arquivo: '. $file_path .' | Tamanho: '. format_bytes($file_size) , $str_log_oculto, '', '', '', '');
    ...
    public function delete($print_response = true) {
        ...
        if ($success) {
            ...
            logs($_SESSION[id_acesso], $_SESSION[id_usuario], $_SESSION[perfil], 1, $id_emissao, 'memorandos', 'Apaga arquivo carregado', 'Arquivo: '. $file_path .' / '. $file_name[0] , $str_log_oculto, '', '', '', '');
