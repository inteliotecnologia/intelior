...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/uploads/anexos_temp/'. session_id() .'/',
            'upload_url' => $this->get_full_url().'/uploads/anexos_temp/'. session_id() .'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            'accept_file_types' => '/\.(gif|jpe?g|png|bmp|doc|docx|xls|xlsx|ppt|pptx|pages|numbers|pdf|rtf|dwg|zip|rar|xml|txt)$/i',
