...
if (pode("12", $_SESSION["perfil"])) {
	...
	if ($acao=='e') {
		...
		$result= mysql_query("select * from  clientes, pessoas
								where clientes.id_cliente = '". $_GET["id_cliente"] ."'
	...
	<div class="col-md-12">
		<div class="page-header">
			<h1>Cliente <small><?=$st;?> cliente</small></h1>
		</div>
		
		<form enctype="multipart/form-data" action="<?= AJAX_FORM; ?>formCliente&amp;acao=<?= $acao; ?>" method="post" name="form">
		    
		    <? if ($acao=='e') { ?>
		    <input name="id_cliente" class="escondido" type="hidden" id="id_cliente" value="<?= $rs->id_cliente; ?>" />
	        ...
	        <div class="row">
	        	<div class="col-md-5">
                	...
                	<input type="text" name="nome2" id="nome2" class="form-control"  value="<?= $rs->nome2; ?>" placeholder="Nome" />
					<br />
		    ...
		    <div class="form-actions">
				...
				<a type="button" class="btn btn-default cancelar" href="./?pagina=acesso/clientes">Cancelar</a>
		    </div>
