...
# Database: intelior
# Generation Time: 2014-03-16 18:29:21 +0000
# ************************************************************
...
CREATE TABLE `acessos` (
  `id_acesso` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `id_usuario` int(11) DEFAULT NULL,
  `perfil` tinyint(3) DEFAULT NULL,
  `data` date DEFAULT NULL,
  `hora` time DEFAULT NULL,
  `ip` varchar(63) DEFAULT NULL,
  `ip_reverso` varchar(255) DEFAULT NULL,
...
INSERT INTO `acessos` (`id_acesso`, `id_usuario`, `perfil`, `data`, `hora`, `ip`, `ip_reverso`, `user_agent`, `referer`, `id_setor`, `session_id`)
VALUES
	(17889,1,0,'2014-03-15','22:40:48','::1','localhost','Mozilla/5.0 (Macintosh; Intel Mac OS X 10.9; rv:27.0) Gecko/20100101 Firefox/27.0','http://localhost/2014/intelior/index2.php?pagina=login&erro=l',0,'20686kk1q7a716f2anghbllnp7'),
	(17890,1,1,'2014-03-15','22:44:19','::1','localhost','Mozilla/5.0 (Macintosh; Intel Mac OS X 10.9; rv:27.0) Gecko/20100101 Firefox/27.0','http://localhost/2014/intelior/index2.php?pagina=login&erro=t',0,'20686kk1q7a716f2anghbllnp7'),
	(17891,1,1,'2014-03-16','00:09:05','::1','localhost','Mozilla/5.0 (Macintosh; Intel Mac OS X 10.9; rv:27.0) Gecko/20100101 Firefox/27.0','http://localhost/2014/intelior/index2.php?pagina=login&erro=t',0,'20686kk1q7a716f2anghbllnp7'),
	(17892,1,1,'2014-03-16','00:37:16','::1','localhost','Mozilla/5.0 (Macintosh; Intel Mac OS X 10.9; rv:27.0) Gecko/20100101 Firefox/27.0','http://localhost/2014/intelior/index2.php?pagina=login&erro=t',0,'20686kk1q7a716f2anghbllnp7');

/*!40000 ALTER TABLE `acessos` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table arquivos
# ------------------------------------------------------------

DROP TABLE IF EXISTS `arquivos`;

CREATE TABLE `arquivos` (
  `id_arquivo` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `arquivos` (`id_arquivo`, `tabela`, `id`, `tamanho`, `arquivo`, `tipo`, `hash_arquivo`, `id_usuario`, `status`, `id_acesso`)
VALUES
	(2,'notas',1,4214,'extrato.png','image/png','4744657CCD7E430DBB135DD9',1,1,17892),
	(4,'notas',3,35984,'TAXA Registro na PMF.pdf','application/x-download','EB88E370FCC95721B2AE3EFF',1,1,17892),
	(5,'notas',4,35806,'Taxa NFe.pdf','application/x-download','74243A15B845FB44BB22B820',1,1,17892),
	(13,'notas',7,13236,'nota_092514-1.xml','text/xml','AFBD8C71735CCABB1754905A',1,1,17892),
	(14,'notas',7,4734,'nota_092514-1.pdf','application/x-download','80894859E33BA46D959B8B1A',1,1,17892),
	(15,'notas',6,13272,'nota_092514-2.xml','text/xml','A2858F4414F0C5BEA685773D',1,1,17892),
	(16,'notas',6,4718,'nota_092514-2.pdf','application/x-download','B2EF3D3BE53632198F168AA9',1,1,17892),
	(17,'notas',5,136843,'INTELIO.pdf','application/x-download','D471AA2EBA1A43260F601444',1,1,17892);

/*!40000 ALTER TABLE `arquivos` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table cad_perfis
# ------------------------------------------------------------

DROP TABLE IF EXISTS `cad_perfis`;
...
LOCK TABLES `cad_perfis` WRITE;
/*!40000 ALTER TABLE `cad_perfis` DISABLE KEYS */;

INSERT INTO `cad_perfis` (`id_perfil`, `perfil`, `descricao`, `status`)
VALUES
...
/*!40000 ALTER TABLE `cad_perfis` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table cad_temas
# ------------------------------------------------------------

DROP TABLE IF EXISTS `cad_temas`;

CREATE TABLE `cad_temas` (
...
LOCK TABLES `cad_temas` WRITE;
/*!40000 ALTER TABLE `cad_temas` DISABLE KEYS */;

INSERT INTO `cad_temas` (`id_tema`, `tema`, `status`)
VALUES
	(1,'Amelia',1),
	(2,'Cerulean',1),
	(3,'Cosmo',1),
...
/*!40000 ALTER TABLE `cad_temas` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table carteiras
# ------------------------------------------------------------

DROP TABLE IF EXISTS `carteiras`;

CREATE TABLE `carteiras` (
  `id_carteira` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `carteiras` (`id_carteira`, `carteira`, `saldo`, `status`, `id_usuario`)
VALUES
	(1,'Em espécie',0.00,1,1),
	(2,'F2b',0.00,1,1),
	(3,'Banco do Brasil',0.00,1,1);
...
CREATE TABLE `cidades` (
  `id_cidade` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `cidade` varchar(255) DEFAULT NULL,
  `id_uf` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_cidade`),
  KEY `UF` (`id_uf`),
  CONSTRAINT `UF` FOREIGN KEY (`id_uf`) REFERENCES `ufs` (`id_uf`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `cidades` WRITE;
/*!40000 ALTER TABLE `cidades` DISABLE KEYS */;

INSERT INTO `cidades` (`id_cidade`, `cidade`, `id_uf`)
VALUES
	(1,'Afonso Cláudio',8),
...
INSERT INTO `clientes` (`id_cliente`, `id_pessoa`, `tags`, `id_usuario`)
VALUES
	(1,3,'site, manutenção',1),
	(2,5,'site',1),
	(4,7,'',1);
...
# Dump of table contas_despesas_pessoas
# ------------------------------------------------------------

DROP TABLE IF EXISTS `contas_despesas_pessoas`;

CREATE TABLE `contas_despesas_pessoas` (
  `id_conta` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `id_pessoa` int(11) DEFAULT NULL,
  `valor` int(11) DEFAULT NULL,
  `tags` int(11) DEFAULT NULL COMMENT 'fornecedor, comissao, parceiro',
  PRIMARY KEY (`id_conta`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;



# Dump of table fornecedores
# ------------------------------------------------------------
...
INSERT INTO `fornecedores` (`id_fornecedor`, `id_pessoa`, `tags`, `id_usuario`)
VALUES
	(1,2,'contabilidade',1),
	(2,6,'',1);
...
# Dump of table instrucoes
# ------------------------------------------------------------

DROP TABLE IF EXISTS `instrucoes`;

CREATE TABLE `instrucoes` (
  `id_instrucao` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `logs` (
  ...
  `tipo` tinyint(1) DEFAULT NULL COMMENT '0: erro | 1: OK',
  `id_referencia` int(11) DEFAULT NULL,
  `area` varchar(255) DEFAULT NULL,
  `acao` varchar(255) DEFAULT '',
  `descricao` text,
  `descricao_oculta` text,
  `data` date DEFAULT NULL,
  `hora` time DEFAULT NULL,
...
INSERT INTO `logs` (`id_log`, `id_acesso`, `id_usuario`, `perfil`, `tipo`, `id_referencia`, `area`, `acao`, `descricao`, `descricao_oculta`, `data`, `hora`, `ip`, `ip_reverso`, `user_agent`, `referer`)
VALUES
	(96151,17889,1,0,1,0,'login','Login com sucesso','','','2014-03-15','22:40:48','::1','localhost','Mozilla/5.0 (Macintosh; Intel Mac OS X 10.9; rv:27.0) Gecko/20100101 Firefox/27.0','http://localhost/2014/intelior/index2.php?pagina=login&erro=l'),
	(96152,17889,1,0,1,0,'login','Faz logout','','','2014-03-15','22:44:13','::1','localhost','Mozilla/5.0 (Macintosh; Intel Mac OS X 10.9; rv:27.0) Gecko/20100101 Firefox/27.0',''),
	(96153,17890,1,1,1,0,'login','Login com sucesso','','','2014-03-15','22:44:19','::1','localhost','Mozilla/5.0 (Macintosh; Intel Mac OS X 10.9; rv:27.0) Gecko/20100101 Firefox/27.0','http://localhost/2014/intelior/index2.php?pagina=login&erro=t'),
	(96154,17890,1,1,1,0,'login','Faz logout','','','2014-03-16','00:09:00','::1','localhost','Mozilla/5.0 (Macintosh; Intel Mac OS X 10.9; rv:27.0) Gecko/20100101 Firefox/27.0','http://localhost/2014/intelior/?pagina=painel'),
	(96155,17891,1,1,1,0,'login','Login com sucesso','','','2014-03-16','00:09:05','::1','localhost','Mozilla/5.0 (Macintosh; Intel Mac OS X 10.9; rv:27.0) Gecko/20100101 Firefox/27.0','http://localhost/2014/intelior/index2.php?pagina=login&erro=t'),
	(96156,17891,1,1,1,1,'dados_pessoais','Altera dados','','','2014-03-16','00:34:29','','','',''),
	(96157,17891,1,1,1,1,'dados_pessoais','Altera dados','','','2014-03-16','00:35:36','','','',''),
	(96158,17891,1,1,1,0,'login','Faz logout','','','2014-03-16','00:37:14','::1','localhost','Mozilla/5.0 (Macintosh; Intel Mac OS X 10.9; rv:27.0) Gecko/20100101 Firefox/27.0','http://localhost/2014/intelior/?pagina=acesso/dados&erros=0'),
	(96159,17892,1,1,1,0,'login','Login com sucesso','','','2014-03-16','00:37:16','::1','localhost','Mozilla/5.0 (Macintosh; Intel Mac OS X 10.9; rv:27.0) Gecko/20100101 Firefox/27.0','http://localhost/2014/intelior/index2.php?pagina=login&erro=t'),
	(96160,17892,1,1,1,0,'clientes','Insere cliente','Cliente: ',' \r\n senha: ','2014-03-16','00:48:55','','','',''),
	(96161,17892,1,1,1,0,'clientes','Insere cliente','Cliente: ',' \r\n senha: ','2014-03-16','00:56:46','','','',''),
	(96162,17892,1,1,1,2,'clientes','Edita cliente','Cliente: Agência Memo \r\n ','','2014-03-16','01:00:16','','','',''),
	(96163,17892,1,1,1,2,'clientes','Edita cliente','Cliente: Agência Memo \r\n ','','2014-03-16','01:01:00','','','',''),
	(96164,17892,1,1,1,2,'clientes','Edita cliente','Cliente: Agência Memo \r\n ','','2014-03-16','01:01:18','','','',''),
	(96165,17892,1,1,1,1,'clientes','Edita cliente','Cliente: Vista Skate \r\n ','','2014-03-16','01:02:08','','','',''),
	(96166,17892,1,1,1,1,'clientes','Edita cliente','Cliente: Vista Skate \r\n ','','2014-03-16','01:02:13','','','',''),
	(96167,17892,1,1,1,2,'clientes','Edita cliente','Cliente: Agência Memo \r\n ','','2014-03-16','01:02:20','','','',''),
	(96168,17892,1,1,1,1,'clientes','Edita cliente','Cliente: Vista Skate \r\n ','','2014-03-16','01:08:36','','','',''),
	(96169,17892,1,1,1,1,'clientes','Edita cliente','Cliente: Vista Skate \r\n ','','2014-03-16','01:18:43','','','',''),
	(96170,17892,1,1,1,1,'clientes','Edita cliente','Cliente: Vista Skate \r\n ','','2014-03-16','01:18:51','','','',''),
	(96171,17892,1,1,0,0,'navega','404','acesso/fornecedores','','2014-03-16','01:21:03','','','',''),
	(96172,17892,1,1,0,0,'navega','404','acesso/fornecedores','','2014-03-16','01:21:39','','','',''),
	(96173,17892,1,1,0,0,'navega','404','acesso/fornecedores','','2014-03-16','01:21:45','','','',''),
	(96174,17892,1,1,0,0,'navega','404','acesso/fornecedores','','2014-03-16','01:21:54','','','',''),
	(96175,17892,1,1,0,0,'navega','404','acesso/fornecedores','','2014-03-16','01:21:59','','','',''),
	(96176,17892,1,1,0,0,'navega','404','acesso/fornecedores','','2014-03-16','01:22:14','','','',''),
	(96177,17892,1,1,0,0,'navega','404','acesso/fornecedores','','2014-03-16','02:29:56','','','',''),
	(96178,17892,1,1,1,0,'fornecedores','Insere fornecedor','fornecedor: ',' \r\n senha: ','2014-03-16','03:24:10','','','',''),
	(96179,17892,1,1,0,0,'navega','404','acesso/carteiras','','2014-03-16','03:29:53','','','',''),
	(96180,17892,1,1,0,0,'navega','404','acesso/propostas','','2014-03-16','03:41:58','','','',''),
	(96181,17892,1,1,0,0,'navega','404','acesso/nota','','2014-03-16','04:17:19','','','',''),
	(96182,17892,1,1,1,0,'notas','Insere nota','Nota: 0','','2014-03-16','15:11:28','','','',''),
	(96183,17892,1,1,0,0,'navega','404','acesso/notas','','2014-03-16','15:11:28','','','',''),
	(96184,17892,1,1,1,0,'notas','Edita nota','Nota: 1 \r\n ','','2014-03-16','15:25:00','','','',''),
	(96185,17892,1,1,1,0,'notas','Edita nota','Nota: 1 \r\n  \r\n cria a pasta uploads//anexos/notas//  \r\n anexa arquivo de uploads/anexos_temp/20686kk1q7a716f2anghbllnp7/6_instrucao_para_solcitar_diarias_passagens_hospedagens_professor.pdf -> uploads//anexos/notas//6_instrucao_para_solcitar_diarias_passagens_hospedagens_professor.pdf / tipo: application/x-download / tamanho: 52.97 KB ','','2014-03-16','16:23:09','','','',''),
	(96186,17892,1,1,1,1,'fornecedores','Edita fornecedor','fornecedor: Contabiliza Contabilidade \r\n ','','2014-03-16','16:44:04','','','',''),
	(96187,17892,1,1,1,1,'fornecedores','Edita fornecedor','fornecedor: Contabiliza Contabilidade \r\n ','','2014-03-16','16:44:27','','','',''),
	(96188,17892,1,1,1,1,'fornecedores','Edita fornecedor','fornecedor: Contabiliza Contabilidade \r\n ','','2014-03-16','16:46:07','','','',''),
	(96189,17892,1,1,1,1,'clientes','Edita cliente','Cliente: Vista Skate \r\n ','','2014-03-16','16:49:10','','','',''),
	(96190,17892,1,1,1,1,'clientes','Edita cliente','Cliente: Vista Skate \r\n ','','2014-03-16','16:49:33','','','',''),
	(96191,17892,1,1,1,2,'clientes','Edita cliente','Cliente: Agência Memo \r\n ','','2014-03-16','16:50:12','','','',''),
	(96192,17892,1,1,1,0,'notas','Edita nota','Nota: 1 \r\n ','','2014-03-16','16:51:00','','','',''),
	(96193,17892,1,1,1,0,'notas','Insere nota','Nota: 0','','2014-03-16','16:54:27','','','',''),
	(96194,17892,1,1,1,0,'notas','Edita nota','Nota: 2 \r\n ','','2014-03-16','16:54:57','','','',''),
	(96195,17892,1,1,1,2,'fornecedores','Edita fornecedor','fornecedor: Prefeitura de Florianópolis \r\n ','','2014-03-16','16:57:18','','','',''),
	(96196,17892,1,1,1,0,'notas','Insere nota','Nota: S/N','','2014-03-16','16:58:22','','','',''),
	(96197,17892,1,1,1,0,'notas','Insere nota','Nota: S/N','','2014-03-16','16:59:53','','','',''),
	(96198,17892,1,1,1,0,'notas','Insere nota','Nota: S/N','','2014-03-16','17:04:04','','','',''),
	(96199,17892,1,1,1,0,'notas','Insere nota','Nota: 002','','2014-03-16','17:05:27','','','',''),
	(96200,17892,1,1,1,0,'notas','Insere nota','Nota: 001','','2014-03-16','17:06:08','','','',''),
	(96201,17892,1,1,0,0,'navega','404','acesso/proposta','','2014-03-16','17:06:44','','','',''),
	(96202,17892,1,1,1,0,'clientes','Insere cliente','Cliente: Intermix Tecnologia',' \r\n senha: ','2014-03-16','17:08:27','','','',''),
	(96203,17892,1,1,1,0,'notas','Edita nota','Nota: 1 \r\n  \r\n anexa arquivo de uploads/anexos_temp/20686kk1q7a716f2anghbllnp7/extrato.png -> uploads//anexos/notas//extrato.png / tipo: image/png / tamanho: 4.12 KB ','','2014-03-16','17:52:24','','','',''),
	(96204,17892,1,1,1,0,'notas','Edita nota','Nota: 3 \r\n  \r\n anexa arquivo de uploads/anexos_temp/20686kk1q7a716f2anghbllnp7/TAXA Registro na PMF.pdf -> uploads//anexos/notas//TAXA Registro na PMF.pdf / tipo: application/x-download / tamanho: 35.14 KB ','','2014-03-16','17:55:34','','','',''),
	(96205,17892,1,1,1,0,'notas','Edita nota','Nota: 3 \r\n  \r\n cria a pasta uploads//anexos/notas/BC8FEF242E27D06ECFC8304B/  \r\n anexa arquivo de uploads/anexos_temp/20686kk1q7a716f2anghbllnp7/TAXA Registro na PMF.pdf -> uploads//anexos/notas/BC8FEF242E27D06ECFC8304B/TAXA Registro na PMF.pdf / tipo: application/x-download / tamanho: 35.14 KB ','','2014-03-16','17:56:36','','','',''),
	(96206,17892,1,1,1,0,'notas','Edita nota','Nota: 4 \r\n  \r\n cria a pasta uploads//anexos/notas/0FC5A3DFCEBED5ABB374EDF5/  \r\n anexa arquivo de uploads/anexos_temp/20686kk1q7a716f2anghbllnp7/Taxa NFe.pdf -> uploads//anexos/notas/0FC5A3DFCEBED5ABB374EDF5/Taxa NFe.pdf / tipo: application/x-download / tamanho: 34.97 KB ','','2014-03-16','18:00:22','','','',''),
	(96207,17892,1,1,1,0,'notas','Edita nota','Nota: 4 \r\n  \r\n anexa arquivo de uploads/anexos_temp/20686kk1q7a716f2anghbllnp7/Taxa NFe.pdf -> uploads//anexos/notas/0FC5A3DFCEBED5ABB374EDF5/Taxa NFe.pdf / tipo: application/x-download / tamanho: 34.97 KB ','','2014-03-16','18:04:15','','','',''),
	(96208,17892,1,1,1,0,'notas','Edita nota','Nota: 7 \r\n  \r\n cria a pasta uploads//anexos/notas/753B0B30DD138B87F11089FE/  \r\n anexa arquivo de uploads/anexos_temp/20686kk1q7a716f2anghbllnp7/nota_092514-1.xml -> uploads//anexos/notas/753B0B30DD138B87F11089FE/nota_092514-1.xml / tipo: text/xml / tamanho: 12.93 KB  \r\n anexa arquivo de uploads/anexos_temp/20686kk1q7a716f2anghbllnp7/nota_092514-1.pdf -> uploads//anexos/notas/753B0B30DD138B87F11089FE/nota_092514-1.pdf / tipo: application/x-download / tamanho: 4.62 KB ','','2014-03-16','18:05:18','','','',''),
	(96209,17892,1,1,1,0,'notas','Edita nota','Nota: 7 \r\n  \r\n anexa arquivo de uploads/anexos_temp/20686kk1q7a716f2anghbllnp7/nota_092514-1.xml -> uploads//anexos/notas/753B0B30DD138B87F11089FE/nota_092514-1.xml / tipo: text/xml / tamanho: 12.93 KB  \r\n anexa arquivo de uploads/anexos_temp/20686kk1q7a716f2anghbllnp7/nota_092514-1.pdf -> uploads//anexos/notas/753B0B30DD138B87F11089FE/nota_092514-1.pdf / tipo: application/x-download / tamanho: 4.62 KB ','','2014-03-16','18:07:00','','','',''),
	(96210,17892,1,1,1,0,'notas','Edita nota','Nota: 7 \r\n  \r\n anexa arquivo de uploads/anexos_temp/20686kk1q7a716f2anghbllnp7/nota_092514-1.pdf -> uploads//anexos/notas/753B0B30DD138B87F11089FE/nota_092514-1.pdf / tipo: undefined / tamanho: 4.62 KB  \r\n anexa arquivo de uploads/anexos_temp/20686kk1q7a716f2anghbllnp7/nota_092514-1.xml -> uploads//anexos/notas/753B0B30DD138B87F11089FE/nota_092514-1.xml / tipo: undefined / tamanho: 12.93 KB ','','2014-03-16','18:07:15','','','',''),
	(96211,17892,1,1,1,0,'notas','Edita nota','Nota: 7 \r\n  \r\n cria a pasta uploads//anexos/notas/753B0B30DD138B87F11089FE/  \r\n anexa arquivo de uploads/anexos_temp/20686kk1q7a716f2anghbllnp7/nota_092514-1.xml -> uploads//anexos/notas/753B0B30DD138B87F11089FE/nota_092514-1.xml / tipo: text/xml / tamanho: 12.93 KB  \r\n anexa arquivo de uploads/anexos_temp/20686kk1q7a716f2anghbllnp7/nota_092514-1.pdf -> uploads//anexos/notas/753B0B30DD138B87F11089FE/nota_092514-1.pdf / tipo: application/x-download / tamanho: 4.62 KB ','','2014-03-16','18:08:00','','','',''),
	(96212,17892,1,1,1,0,'notas','Edita nota','Nota: 6 \r\n  \r\n cria a pasta uploads//anexos/notas/B3DA690845775F670C189582/  \r\n anexa arquivo de uploads/anexos_temp/20686kk1q7a716f2anghbllnp7/nota_092514-2.xml -> uploads//anexos/notas/B3DA690845775F670C189582/nota_092514-2.xml / tipo: text/xml / tamanho: 12.96 KB  \r\n anexa arquivo de uploads/anexos_temp/20686kk1q7a716f2anghbllnp7/nota_092514-2.pdf -> uploads//anexos/notas/B3DA690845775F670C189582/nota_092514-2.pdf / tipo: application/x-download / tamanho: 4.61 KB ','','2014-03-16','18:09:15','','','',''),
	(96213,17892,1,1,1,0,'notas','Edita nota','Nota: 5 \r\n  \r\n cria a pasta uploads//anexos/notas/6937948181D900B4EBDDF4AA/  \r\n anexa arquivo de uploads/anexos_temp/20686kk1q7a716f2anghbllnp7/INTELIO.pdf -> uploads//anexos/notas/6937948181D900B4EBDDF4AA/INTELIO.pdf / tipo: application/x-download / tamanho: 133.64 KB ','','2014-03-16','18:09:52','','','',''),
	(96214,17892,1,1,1,0,'propostas','Insere proposta','Proposta: 1 \r\n Proposta: Criac?a?o de website em 2 li?nguas com ambiente administrativo para atender as necessidades da Intermix','','2014-03-16','18:31:10','','','',''),
	(96215,17892,1,1,1,0,'notas','Edita nota','Nota:  \r\n ','','2014-03-16','18:52:34','','','',''),
	(96216,17892,1,1,1,0,'notas','Edita nota','Nota:  \r\n ','','2014-03-16','18:52:56','','','',''),
	(96217,17892,1,1,1,0,'notas','Edita nota','Nota:  \r\n ','','2014-03-16','18:54:08','','','',''),
	(96218,17892,1,1,1,0,'notas','Edita nota','Nota:  \r\n ','','2014-03-16','18:56:05','','','',''),
	(96219,17892,1,1,1,0,'propostas','Insere proposta','Proposta: 2 \r\n Proposta: teste memo','','2014-03-16','18:58:05','','','',''),
	(96220,17892,1,1,1,0,'propostas','Insere proposta','Proposta: 3 \r\n Proposta: teste memo','','2014-03-16','18:58:37','','','',''),
	(96221,17892,1,1,1,3,'propostas','Apaga proposta','Proposta: 3','','2014-03-16','19:00:13','','','',''),
	(96222,17892,1,1,1,0,'notas','Edita nota','Nota:  \r\n ','','2014-03-16','19:00:56','','','',''),
	(96223,17892,1,1,1,0,'notas','Edita nota','Nota:  \r\n ','','2014-03-16','19:03:31','','','',''),
	(96224,17892,1,1,1,0,'notas','Edita nota','Nota:  \r\n ','','2014-03-16','19:04:18','','','',''),
	(96225,17892,1,1,1,0,'notas','Edita nota','Nota:  \r\n ','','2014-03-16','19:06:05','','','','');
...
CREATE TABLE `notas` (
  `id_nota` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `tipo_nota` int(11) DEFAULT NULL COMMENT 'despesa / receita',
...
INSERT INTO `notas` (`id_nota`, `tipo_nota`, `id_carteira`, `id_projeto`, `id_pessoa`, `id_proposta`, `numero`, `data`, `valor`, `descricao`, `status`, `hash`, `id_usuario`, `id_acesso`)
VALUES
	(1,2,1,0,2,0,'0','2014-01-24',350.00,'1/2 Honorários de abertura da empresa.',1,'092JH03FHJW0E9F09UD19229',1,17892),
	(2,2,1,0,2,0,'0','2014-02-25',350.00,'2/2 Abertura da empresa.',1,'96AE9361A481FE51F0FD4BCF',1,17892),
	(3,2,1,0,6,0,'S/N','2014-01-31',47.56,'Taxa de registro na prefeitura.',1,'BC8FEF242E27D06ECFC8304B',1,17892),
	(4,2,1,0,6,0,'S/N','2014-02-03',35.66,'Taxa de solicitação da NF-e.',1,'0FC5A3DFCEBED5ABB374EDF5',1,17892),
	(5,2,1,0,2,0,'S/N','2014-03-10',362.00,'Honorários ref. 02/2014',1,'6937948181D900B4EBDDF4AA',1,17892),
	(6,1,2,0,5,0,'002','2014-03-06',250.00,'Tapume Memo.',1,'B3DA690845775F670C189582',1,17892),
	(7,1,2,0,3,0,'001','2014-03-06',532.00,'Manutenção vista.art.br',1,'753B0B30DD138B87F11089FE',1,17892);

/*!40000 ALTER TABLE `notas` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table opcoes
# ------------------------------------------------------------
...
CREATE TABLE `pessoas` (
  ...
  `nome2` varchar(255) NOT NULL DEFAULT '',
...
INSERT INTO `pessoas` (`id_pessoa`, `nome`, `nome2`, `email`, `cpf_cnpj`, `status`, `id_usuario`, `id_acesso`)
VALUES
	(1,'Jaison Niehues','','jaison@intelio.com.br','049.408.369-75',1,1,NULL),
	(2,'Contabiliza Contabilidade','HS Contabiliza S/S Ltda ME','diego@contabiliza.net','07.681.490/0001-88',1,1,NULL),
	(3,'Vista Skate','Alexandre Reinhardt Marten - ME','xande@vista.art.br','03.842.496/0001-39',1,1,NULL),
	(5,'Agência Memo','Agência Memo Ltda','raphael.barbosa@agenciamemo.com.br','08.965.174/0001-09',1,1,17892),
	(6,'Prefeitura de Florianópolis','Prefeitura Municipal de Florianopolis','contato@pmf.sc.gov.br','82.892.282/0001-43',1,1,17892),
	(7,'Intermix Tecnologia','','intermix@matrix.com.br','',1,1,17892);

/*!40000 ALTER TABLE `pessoas` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table pessoas_meta
# ------------------------------------------------------------

DROP TABLE IF EXISTS `pessoas_meta`;

CREATE TABLE `pessoas_meta` (
  `id_pessoa_meta` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `id_pessoa` int(11) DEFAULT NULL,
  `meta` varchar(255) DEFAULT NULL,
  `valor` varchar(255) DEFAULT NULL,
  `id_usuario` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_pessoa_meta`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `pessoas_meta` WRITE;
/*!40000 ALTER TABLE `pessoas_meta` DISABLE KEYS */;

INSERT INTO `pessoas_meta` (`id_pessoa_meta`, `id_pessoa`, `meta`, `valor`, `id_usuario`)
VALUES
	(38,5,'telefone','(11) 3861-3213',1),
	(39,5,'latitude','',1),
	(40,5,'longitude','',1),
	(41,5,'id_cidade','5270',1),
	(42,5,'cliente_desde','01/02/2013',1),
	(43,0,'telefone','',1),
	(44,0,'latitude','',1),
	(45,0,'longitude','',1),
	(46,0,'id_cidade','5270',1),
	(47,0,'cliente_desde','01/02/2013',1),
	(48,3,'telefone','(11) 2305-2306',1),
	(49,3,'latitude','',1),
	(50,3,'longitude','',1),
	(51,3,'id_cidade','5270',1),
	(52,3,'cliente_desde','01/03/2008',1),
	(53,6,'telefone','',1),
	(54,6,'latitude','',1),
	(55,6,'longitude','',1),
	(56,6,'id_cidade','4500',1),
	(57,6,'cliente_desde','18/01/2014',1),
	(58,2,'telefone','(48) 3207-2070',1),
	(59,2,'latitude','',1),
	(60,2,'longitude','',1),
	(61,2,'id_cidade','4500',1),
	(62,2,'cliente_desde','01/02/2014',1),
	(63,7,'telefone','',1),
	(64,7,'latitude','',1),
	(65,7,'longitude','',1),
	(66,7,'id_cidade','4688',1),
	(67,7,'cliente_desde','',1);

/*!40000 ALTER TABLE `pessoas_meta` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `produtos` (`id_produto`, `produto`, `preco`)
VALUES
	(1,'e-Doc Memorando Eletrônico',NULL);

/*!40000 ALTER TABLE `produtos` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table produtos_precos
# ------------------------------------------------------------
...
CREATE TABLE `projetos` (
  ...
  `estatistica_id` int(11) DEFAULT NULL,
  `id_usuario` int(11) DEFAULT NULL,
...
# Dump of table propostas
# ------------------------------------------------------------

DROP TABLE IF EXISTS `propostas`;

CREATE TABLE `propostas` (
  `id_proposta` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `tipo_proposta` int(11) DEFAULT NULL,
  `id_pessoa` int(11) DEFAULT NULL,
...
INSERT INTO `propostas` (`id_proposta`, `tipo_proposta`, `id_pessoa`, `num`, `subnum`, `ano`, `proposta`, `descricao`, `data`, `hora`, `valor`, `valido_ate`, `hash`, `status`, `id_usuario`, `id_acesso`)
VALUES
	(1,1,7,1,0,2014,'Criação de website em 2 línguas com ambiente administrativo para atender as necessidades da Intermix','<p>- Projeto gr&aacute;fico de acordo com refer&ecirc;ncias enviadas em e-mail preliminar e reuni&atilde;o presencial.<br />- Cria&ccedil;&atilde;o de ambiente administrativo, possibilitando a atualiza&ccedil;&atilde;o de todas as &aacute;reas do site por meio de usu&aacute;rio e senha.<br />- Sess&otilde;es previstas: P&aacute;gina inicial / Sobre / Produtos / Clientes / Help Desk / Chat / Contato. - Help Desk inclui a cria&ccedil;&atilde;o de um sistema de ticket, para atendimento de clientes.<br />- Chat inclui um ambiente para conversa em tempo real com algum membro da equipe Intermix. - Treinamento para atualiza&ccedil;&atilde;o do website.<br />- Inclus&atilde;o do conte&uacute;do inicial do website, fornecido pelo cliente nas 2 l&iacute;nguas requeridas: Portugu&ecirc;s-BR e Ingl&ecirc;s.<br />- Apresenta&ccedil;&atilde;o das estat&iacute;sticas de acesso durante o primeiro m&ecirc;s online.<br />- A contrata&ccedil;&atilde;o do servidor de hospedagem n&atilde;o est&aacute; inclusa nesta proposta, sugere-se continuar com a atual caso a demanda por acesso n&atilde;o aumente de maneira consider&aacute;vel.<br />- Website se adapta a computador, tablet e smartphone.</p>\r\n<p><strong>Investimento em cria&ccedil;&atilde;o:</strong></p>\r\n<p>Cria&ccedil;&atilde;o:<br />R$7.200,00</p>\r\n<p>Help Desk:<br />R$1.350,00</p>\r\n<p>Chat b&aacute;sico:<br />R$800,00</p>\r\n<p>L&iacute;ngua adicional:<br />R$1.440,00</p>\r\n<p>Total da proposta:<br />R$10.790,00 incluindo Nota Fiscal.</p>\r\n<p><strong>Investimento em manuten&ccedil;&atilde;o mensal (opcional)</strong></p>\r\n<p>Hospedagem:<br />R$29,90</p>\r\n<p>Suporte:<br />R$100,00 (3 horas mensais)</p>\r\n<p>Condi&ccedil;&otilde;es a combinar.</p>','2014-03-05','17:00:00',10790.00,'2014-04-05','2DE0C5195065E947636220AA',1,1,17892);

/*!40000 ALTER TABLE `propostas` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table servidores
# ------------------------------------------------------------

DROP TABLE IF EXISTS `servidores`;

CREATE TABLE `servidores` (
  `id_servidor` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ufs` (
  ...
  `uf_extenso` varchar(75) DEFAULT NULL,
...
INSERT INTO `ufs` (`id_uf`, `uf_extenso`, `uf`, `id_pais`)
VALUES
	(1,'Acre','AC',1),
	(2,'Alagoas','AL',1),
	(3,'Amazonas','AM',1),
...
CREATE TABLE `usuarios` (
  ...
  `senha_sem` varchar(255) DEFAULT NULL,
...
INSERT INTO `usuarios` (`id_usuario`, `id_pessoa`, `senha`, `senha_sem`, `perfil`, `tema`, `foto`, `ultimo_login`, `id_usuario_criou`)
VALUES
	(1,1,'467b617fec4d9fcb63505734ee224851','nao',1,NULL,'uploads/1_IMG_6225.JPG','2014-03-16 00:37:16',1);
